...
<body>
	...
	<div class="container">
		<h2>Store Inventory <small><a href="Add" style="margin-left:1em">[Add Item]</a> <a href="History" style="margin-left:1em">[View Transactions]</a></small></h2>
			...
			<c:otherwise>
				<table class="table table-bordered table-striped table-hover">
					...
					<c:forEach items="${inventory}" var="item">
						<tr>
							<td><a href="Details?id=${item.id}"><c:out value="${item.name}" escapeXml="true" /></a></td> <td>${item.quantity}</td> <td>${item.price}</td> 
							<td>
